    ...
    <div className="w-full max-w-md rounded-xl border border-stone-200 bg-white p-8 shadow-sm">
      <div className="mb-8 text-center">
        ...
        <p className="mt-2 text-sm text-stone-600">
          Masukkan email dan password organizer untuk mengelola event
        </p>
      </div>

      {registered === "true" && (
        <div className="mb-6 rounded-md bg-teal-50 p-4 text-sm text-teal-800">
          Akun organizer berhasil dibuat. Silakan login.
        </div>
      )}
      ...
      {googleEnabled ? (
        <>
          <div className="mt-6 flex items-center justify-between">
            ...
            <span className="px-3 text-xs uppercase text-stone-400">Atau</span>
            <span className="h-px w-full bg-stone-200" />
          </div>
